...
const NavItem: React.FC<{
  ...
  return (
    <button
      ...
      className={`flex flex-col items-center justify-center w-16 transition-colors duration-300 ${isActive ? 'text-amber-400 dark:text-glow-amber' : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'}`}
    >
      {children}
